...
import triagensRoutes from './routes/triagensRoutes.js';
...
// Exportamos estas funções para que o ficheiro de rotas as consiga ler
export { pool, requireEnfermeiroMedicoOrAdmin, requireMedicoOrAdmin };